...
public class Carrito {
    ...
    public boolean equals(Object o) {
        ...
        return idCarro == carrito.idCarro && idUsuario == carrito.idUsuario && Objects.equals(comidaCantidad, carrito.comidaCantidad) && Objects.equals(idFactura, carrito.idFactura);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idCarro, idUsuario, comidaCantidad, idFactura);
    }
}